...
public:
  ...
  /// MXFP8 scalar operations
  bool visitOp(allo::DecodeE4m3Op op) {
    return emitter.emitMxfp8UnaryCall(op, "allo_decode_e4m3"), true;
  }
  bool visitOp(allo::EncodeE4m3Op op) {
    return emitter.emitMxfp8UnaryCall(op, "allo_encode_e4m3"), true;
  }
  bool visitOp(allo::DecodeE8m0Op op) {
    return emitter.emitMxfp8UnaryCall(op, "allo_decode_e8m0"), true;
  }
  bool visitOp(allo::EncodeE8m0Op op) {
    return emitter.emitMxfp8UnaryCall(op, "allo_encode_e8m0"), true;
  }
...
void allo::hls::VhlsModuleEmitter::emitMxfp8UnaryCall(Operation *op,
                                                      const char *fn) {
  emitUnary(op, fn);
}

void allo::hls::VhlsModuleEmitter::emitMxfp8DecodeBlock(
...
void allo::hls::VhlsModuleEmitter::emitMxfp8EncodeBlock(
...
void allo::hls::VhlsModuleEmitter::emitMxfp8BlockAdd(allo::BlockAddMxfp8Op op) {
...
void allo::hls::VhlsModuleEmitter::emitMxfp8BlockMatMul(
